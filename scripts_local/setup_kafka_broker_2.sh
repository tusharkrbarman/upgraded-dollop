#!/bin/bash
# Setup script for Kafka Broker 2 (Laptop 3) - Local Network Deployment

set -e

echo "=========================================="
echo "Setting up Kafka Broker 2 (Laptop 3)"
...
keytool -keystore /etc/kafka/ssl/server.keystore.jks -alias localhost -validity 365 -genkey -keyalg RSA -storepass your-password -keypass your-password -dname "CN=192.168.1.12, OU=IT, O=DistributedAI, L=City, ST=State, C=US"
...
echo "=========================================="
echo "Kafka Broker 2 setup completed successfully!"
echo "=========================================="
echo ""
echo "IMPORTANT NOTES:"
echo "1. Your IP: 192.168.1.12"
