...
|-------------|----------|
| `opus` | Uses default model (configured in OpenCode settings) |
| `sonnet` | Uses default model (configured in OpenCode settings) |
| `haiku` | Uses default model (configured in OpenCode settings) |
